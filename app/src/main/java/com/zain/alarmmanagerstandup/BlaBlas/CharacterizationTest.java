...
public class CharacterizationTest {
    ...
    public void testTypicalOutput() {
        ...
        Vehicle blueHonda = new Vehicle("Blue Honda 2008", VehicleCategoryCodeEnum.SEDAN.getValue());
        Vehicle greyJeep = new Vehicle("Grey Jeep 2013", VehicleCategoryCodeEnum.FOURxFOUR.getValue());
        Vehicle RedSunny = new Vehicle("Red Sunny 2014", VehicleCategoryCodeEnum.SEDAN.getValue());
        Vehicle BlueBMW = new Vehicle("Blue X3 2017", VehicleCategoryCodeEnum.SUV.getValue());
        ...
        System.out.println(blablaConnect.generateRentalFeesStatementJson());
    }
}
